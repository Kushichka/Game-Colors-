window.addEventListener('DOMContentLoaded', () => {
    ...
    // createGameField //
    const colors = {
        0: { name: 'red', color: '#DC143C', used: 0 },
        1: { name: 'blue', color: '#4169E1', used: 0 },
        2: { name: 'pink', color: '#C71585', used: 0 },
        3: { name: 'violet', color: '#8B008B', used: 0 },
        4: { name: 'yellow', color: '#FFD700', used: 0 },
        5: { name: 'orange', color: '#FF8C00', used: 0 },
        6: { name: 'green', color: '#32CD32', used: 0 },
        7: { name: 'brown', color: '#8B4513', used: 0 }
    };
            ...
            new Promise((resolve, reject) => {
                resolve(
                    fields.forEach(() => {
                        ...
                        square.classList.add('game__field-square', 'shadow', 'closed');
